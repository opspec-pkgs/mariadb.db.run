[![Build Status](https://github.com/opspec-pkgs/mariadb.db.run/workflows/build/badge.svg?branch=master)](https://github.com/opspec-pkgs/mariadb.db.run/actions?query=workflow%3Abuild+branch%3Amaster)
