[![build](https://github.com/opspec-pkgs/mariadb.db.run/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/mariadb.db.run/actions/workflows/build.yml)
